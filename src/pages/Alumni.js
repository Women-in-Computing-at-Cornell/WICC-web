      ...
      <div class="containerPage">
        <center>
          <p style={{ paddingBottom: "3%" }}>
            WICC is creating a network that allows current WICC members to reach
            out to alumni to ask for advice on academic, social and professional
            issues. Should you choose to participate in this network, we would
            ask your permission before putting any WICC members with interests
            similar to yours in contact with you. You don't have to have been in
            WICC during your time at Cornell or even strictly a CS major to
            participate. WICC would truly appreciate your participation in this
            program and we welcome anyone who wishes to create an even wider
            support network for women in computer science and women considering
            joining our community.
          </p>

          <p>
            Would you like to be involved as an alumna? Fill out the form below
            and we will get back to you about all of the exciting opportunities
