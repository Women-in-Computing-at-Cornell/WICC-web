      ...
      <div class="page">
          ...
          <Row style={{ paddingBottom: '2%' }}>
            <Col xs lg="6" style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p style={{ paddingRight: '5%', paddingTop: '2%' }}>
                We provide free Computer Science classes for middle and high school
                students in the greater Ithaca community through Cornell Girls Who
                Code. Students learn the fundamentals of computing as well as cool
                technologies like Arduinos, web programming, and Ozobots.
              </p>
              <center>
                <Button
                  style={{ marginRight: '5%' }}
        ...
        <center>
          ...
          <h5 style={{ fontWeight: 'bold' }}>
            Interested in our Girls Who Code program for this Fall 2021? Register
            here!{' '}
          </h5>
          <Button
            style={{ marginBottom: '3%' }}
            href="https://docs.google.com/forms/d/e/1FAIpQLScBHRS_-ZjYCC0H3A_R6-Lr2QnrgWduBw-K3fNWw89NLrHwvg/viewform"
          >
            Register Now!
          </Button>
        </center>
        ...
        <Container style={{ paddingBottom: '2%' }}>
          <Row style={{ paddingBottom: '1%' }}>
            ...
            <Col style={{ paddingRight: '0%', paddingLeft: '2%' }}>
              <div class="outreachDates">
                ...
                <p>Oct. 3</p>
                <p>
                  <span style={{ textDecoration: 'line-through' }}>Oct. 10</span> NO
                  CLASS *
                </p>
                <p>Oct. 17</p>
                <p>Oct. 24</p>
          ...
          <center>
            <p>
              * Please note we will NOT be having class on October 10th due to
              Cornell's academic break.
            </p>
          </center>
        </Container>
        ...
        <Container>
          ...
          <Row style={{ paddingBottom: '2%' }}>
            ...
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              ...
              <p>
                <span style={{ fontWeight: 'bold' }}>Random Color Generator</span>
              </p>
              <p>Dax</p>
              <p>MS, Fall 2018</p>
            </Col>
            <Col>
              ...
              <p>
                <span style={{ fontWeight: 'bold' }}>Colorful Flashy Flashcard</span>
              </p>
              <p>Audrey</p>
              <p>HS, Fall 2018</p>
          ...
          <Row style={{ paddingBottom: '2%' }}>
            <Col>
              <h6 style={{ fontWeight: 'bold' }}>
                Interested in being a WICC Outreach Volunteer for this Fall 2021?
                Apply here!{' '}
              </h6>
              <Button
              ...
              <p>
                Interested in sponsoring Girls Who Code? Think you would make a good
                guest speaker? Want to be a general volunteer at workshops around the
                local community?
              </p>
              <p>
