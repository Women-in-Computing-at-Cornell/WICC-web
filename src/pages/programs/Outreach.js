  ...
  render() {
    ...
    return (
      <div>
        <div class="hero">
          <div class="hero-text">
            <Link to="/programs"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
              <path d="M15 18.5L9 12.5L15 6.5" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>Back to Programs page</Link>
            <h1 style={{ marginBottom: "1.2rem", marginTop: "1.2rem", fontWeight: "700" }}> Outreach: Girls Who Code </h1>
            <p style={{ paddingRight: "5%", paddingTop: "2%", marginRight: "20%" }}>
            ...
            <p>
              Check out more details on the <a href="https://girlswhocode.com/"><span style={{ fontWeight: "bold" }}>Girls Who Code</span> official website
            ...
            <p>
              Register your account <a href="https://girlswhocode.instructure.com/login/canvas">here
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path d="M7 17L17 7" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M7 7H17V17" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
