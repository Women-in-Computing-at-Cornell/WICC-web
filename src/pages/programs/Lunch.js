          ...
          <Row style={{ paddingBottom: '1%' }}>
            <Col xs lg="6" style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p style={{ paddingRight: '5%', paddingTop: '2%' }}>
                WICC’s weekly Lunch Bunch program is an exceptional opportunity for
                underclassmen women and minorities to make new friends and network
                within the computing community while learning from CIS professors and
                WICC alumni in a casual, conversational setting. Over free catered
                lunch, members talk about various disciplines in technology with
                professors, including David Gries, Jon Kleinberg, Eva Tardos, and
                Walker White.
              </p>
              <br />
              <h4>Times</h4>
          ...
          <Row style={{ paddingBottom: '1%' }}>
            ...
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p>
                ...
                let me cement my decsision to major in CS, as through it I got an
                idea of the potential in the field.
              </p>
            ...
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p>
                “It's much less intimidating talking to them at Lunch Bunch compared
                to going up to them after a big lecture class. Not only do you learn
                about their field, but you also get to know more about them on a
                personal level such as their personality and interests outside of the
                classroom.”
              </p>
            ...
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p>
                “Lunch bunch was such a great experience. I ate great food and met
                great people, and it was awesome to meet with professors in a closer
                setting!”
              </p>
