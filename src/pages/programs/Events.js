        ...
        <Container>
          <Row style={{ paddingBottom: "4%" }}>
            <Col xs lg="6" style={{ paddingRight: "5%", paddingLeft: "0%" }}>
              ...
              >
                WICC events are open to all (and often even have free food for
                all)! They include workshops on career development, socials,
                tech talks with top companies, and more.
              </p>
