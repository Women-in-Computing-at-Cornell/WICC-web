      ...
      <div class="page">
          ...
          <Row style={{ paddingBottom: '1%' }}>
            <Col xs lg="6" style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              <p style={{ paddingRight: '5%', paddingTop: '2%' }}>
                Our mentorship program strives to encourage and support students who
                are pursuing studies or future employment in computing by connecting
                them with more experienced upperclassmen. The role of the mentor is
                to empower their mentees and enhance their interests in computing.
                Mentors and mentees will be matched primarily based on academic and
                career interests.
              </p>
            </Col>
            <Col>
        ...
        <Container>
          ...
          <Row style={{ paddingBottom: '1%' }}>
            <Col style={{ paddingRight: '5%' }}>
              <p>
                As a mentor you are expected to hold conversations with your mentees
                monthly, help your mentees establish meaningful connections, give
                advice on course selection, or otherwise. Any motivated
                undergraduates, graduate students, and grads majoring in or working
                CS or related technical fields can sign-up as a mentor.{' '}
              </p>
            ...
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
              ...
              <ul>
                <li>
                  ...
                  <span style={{ fontWeight: 'bold' }}>sophomores, juniors</span>, or{' '}
                  <span style={{ fontWeight: 'bold' }}>seniors</span> at Cornell.
                </li>
                <li>
                ...
                <li>
                  <span style={{ fontWeight: 'bold' }}>Pre-Enroll Dinner:</span>{' '}
                  share advice about what classes to take, open to anyone in
                  computing majors!
                </li>
                <li>
                  <span style={{ fontWeight: 'bold' }}>One general meeting</span>,
                  which could include: outings with other mentor groups, WICC social
                  events with both the mentors and mentees attending, or additional
                  group meetings.
                </li>
              </ul>
            </Col>
        ...
        <Container>
          ...
          <Row style={{ paddingBottom: '1%' }}>
            <Col style={{ paddingRight: '5%' }}>
              <p>
                Mentees are matched with experienced upperclassmen or alumni mentors
                in groups of 2 mentors and 3-5 other mentees.
              </p>
              <Button href="https://forms.gle/vZeTVhGveoqZ8AWs9">Sign Up</Button>
            </Col>
            <Col style={{ paddingRight: '5%', paddingLeft: '0%' }}>
