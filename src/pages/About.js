      ...
      <div class="home-container">
        <section class="hero-container">
          ...
          <p style={{ fontWeight: "bold", fontSize: 20 }}>
            ...
            student body and local Ithaca community to uplift anyone to succeed
          ...
          <Container>
            <Row style={{ paddingBottom: "4%", paddingLeft: "2%" }}>
              ...
              >
                ...
                <p>
                  WICC’s Community team regularly engages with students
                  interested in tech through our mentorship program, allyship
                  workshops, and socials. Our goal is to help foster meaningful
                  relationships and make anyone feel included and welcome in CIS
                  at Cornell. In the past we’ve hosted the WICC Away retreat and
                  CIS Formal, held community discussions on speaking up for
                  yourself, and hosted multiple allyship events in collaboration
                  with other organizations at Cornell.
                </p>
                <p style={{ fontSize: "90%" }}>
                  <span style={{ fontWeight: "bold" }}> Focus: </span>{" "}
                  Mentorship, Allyship, Social
                </p>
              </Col>
              <Col>
                <Image
            ...
            <Row style={{ paddingBottom: "4%", paddingLeft: "2%" }}>
              ...
              >
                ...
                <p>
                  WICC works to expand opportunities and provide career support
                  by publicizing opportunities for women, hosting alumni women
                  panels, tech talks and networking events with companies.{" "}
                </p>
                <p style={{ fontSize: "90%" }}>
                  <span style={{ fontWeight: "bold" }}> Focus: </span> Career
                  Development, Faculty & Alumni Relations, Underclassmen
                  Outreach
                </p>
              </Col>
              <Col>
            ...
            <Row style={{ paddingBottom: "4%", paddingLeft: "2%" }}>
              ...
              >
                ...
                <p>
                  ...
                  students in the Ithaca area, intended to teach our students
                  the basic principles of computing and encouraging the
                  possibilities beyond these basics. In addition, we host a
                  series of workshops with the Tompkins Public Library three
                  times a semester, aimed at problem solving, critical thinking,
                  and robotics to give younger students a taste of the power of
                  technology. Other workshops in collaboration with
                  organizations like Splash and Hack For Impact are also hosted
                  throughout each semester as a blend of both programs to target
                  a more casual setting for exploring both areas.
                </p>
                <p style={{ fontSize: "90%" }}>
            ...
            <Row style={{ paddingBottom: "4%", paddingLeft: "2%" }}>
              ...
              >
                ...
                <p style={{ fontSize: "90%" }}>
                  <span style={{ fontWeight: "bold" }}> Focus: </span>{" "}
                  Information Sessions, Tech Talks, Networking
                </p>
              </Col>
              <Col>
                <Image
